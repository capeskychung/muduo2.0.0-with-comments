...
// http://192.168.159.188:12345/proc/pid这个 http请求就会相应的调用processInspector::pid来处理
//module对应proc
// command 对应pid
// cb 对应 命令对应的回调函数  ins->add("proc", "pid", ProcessInspector::pid, "print pid"); 中ProcessInspector::pid
// help 对应 文本信息
